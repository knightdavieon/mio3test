        ...
        <div class="container-fluid">
            ...
            <!-- Input -->
               <!-- Item Information Form -->
                <a href="swho_branch_transfer_stocks.php" style="height:30px;width:70px;padding-top:0px;" class="btn btn-warning"><i class="material-icons" style="margin-left:-2px;"> arrow_back </i> Back </a>
                           ...
                           <div class="col-md-12 col-sm-10 col-xs-10">
                                   ...
                                   ?> 
                                      ...
                                      <div class="col-md-4 col-lg-5 col-sm-5 col-xs-5">
                                          ...
                                          <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5">
                                            <label> <?php echo $info_rows['transfer_to']; ?> </label>
                                         </div>
                                          <div class="col-md-4 col-lg-5 col-sm-5 col-xs-5">
            ...
            <div class="row clearfix">
                 <div class="col-md-12 col-lg-12 co-xs-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                                <a href="swho_branch_transfer_stocks_printout.php?r_id=<?php echo stripslashes($_GET['icode']); ?>" class="btn btn-warning" target="_blank" style="height:30px;padding-top:3px;"><i class="material-icons"> print</i> Print Preview </a>
                                <a href="swho_branch_transfer_stocks_pdf.php?r_id=<?php echo stripslashes($_GET['icode']); ?>" class="btn btn-danger" target="_blank" style="height:30px;padding-top:3px;"><i class="material-icons"> picture_as_pdf</i> Export as PDF </a>
                          </div>
                     </div>
                  </div>
             </div>

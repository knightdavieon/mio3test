                                 ...
                                 table.dataTable thead th{
                                    ...
                                    <table id="r_items" class="table table-bordered table-striped">
                                            <thead>
                                                ...
                                                <tbody>
                                                    <?php 
                                                       $branch_query = "Select * from tbl_branch_transfer_series";
                                                      ...
                                                      while($branch_rows = mysqli_fetch_array($branch_result)){
                                                        if($branch_rows['transfer_status'] != "DONE"){

                                                    
                                                        ?>
                                                        <tr>
                                                            <td><a href="approval_page_data.php?icode=<?php echo $branch_rows['transaction_number']; ?>"><?php echo $branch_rows['transaction_number']; ?></td>
                                                            <td><?php echo $branch_rows['staff_name']; ?></td>
                                                            <td><?php echo $branch_rows['staff_code']; ?></td>
                                                            <td><?php echo $branch_rows['branch_code']; ?></td>
                                                            <td><?php echo $branch_rows['transfer_to']; ?></td>
                                                            <td><label><small><?php echo $branch_rows['transaction_date']; ?></small></label></td>
                                                            <td><small><label <?php echo ($branch_rows['transfer_status'] == "PENDING") ? 'style="color:#e65c00;"' : 'style="color:#008000;"'; ?>><?php echo $branch_rows['transfer_status'] ?></label></small</td>
                                                         </tr>
                                                    <?php   
                                                             } 
                                                      }

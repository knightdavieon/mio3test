                         ...
                         <div class="body">
                           ...
                           <div class="col-md-12 col-lg-12 col-sm-10 col-xs-10">
                                ...
                                <div id="content_div">
                                      ...
                                      <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2" id="discount_div">
                              ...
                              function isNumber(evt) {
                               ...
                               $(document).ready(function(){
                                  ...
                                  $('#btn_add').click(function(){
                                        ...
                                        var trans_num = $('#trans_number').val();
     ...
     <!-- #END# of third form -->
      ...
      <!-- Fourth Form -->
            ...
            <div class="row clearfix">
                ...
                <button type="submit" class="btn btn-success" style="margin-left:15px;height:30px;padding-top:0;" name="btn_commit"><i class="material-icons">done_all</i> Commit </button>

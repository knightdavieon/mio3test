...
if(isset($_POST['btn_item_csv'])){

  ob_end_clean();
  $output = fopen('php://output', 'w');
  header('Content-Type: text/csv; charset=utf-8');
  header('Content-Disposition: attachment; filename=branch_to_branch_receive_history_trans_'.$transcode.'.csv');
  ...
  $query = "Select * from tbl_branch_transfer_history where transaction_number = '" . $transcode . "'";
...
<head>
  ...
  <title> Item Received Report </title>
  <!-- Favicon-->
...
<section class="content">
  <div class="container-fluid">
    ...
    <a href="item_receive_branch_table.php" style="height:30px;width:70px;padding-top:0px;" class="btn btn-warning"><i class="material-icons" style="margin-left:-2px;"> arrow_back </i> Back </a>
          ...
          <div class="body">
            ...
            <div class="row clearfix">
              <div class="col-md-12 col-sm-10 col-xs-10">
                ...
                <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5">
                  <label> "<small> <i><?php echo $info_rows['transfer_date']; ?> </i> </small> "</label>
                </div>
    ...
    <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="body">
            <form method="post" action="<?php echo  $_SERVER['PHP_SELF'].'?icode='.$transcode; ?>" enctype="multipart/form-data">
              <h2 class="card-inside-title">
                ...
                <button type="submit" title="Export as CSV" name="btn_item_csv" class="btn btn-success" style="width:30px;height:30px;padding-top:0;"><i class="material-icons" style="margin-left:-6px;margin-top:2px;"> grid_on </i> </button>
              </h2>
              <div class="row clearfix">
                <div class="col-md-12 col-sm-10 col-xs-10">
                  <style type="text/css">
        ...
        <a href="item_receive_branch_table.php" style="margin-bottom: 25px; height:30px;padding-top:0;" class="btn btn-warning"><i class="material-icons" style="margin-left:-2px;"> arrow_back </i> Back </a>
      </div>

...
<button type="submit" class="btn btn-success" style="margin-left:15px;margin-bottom: 25px; height:30px;padding-top:0;" name="btn_commit" onclick="return confirm('Are you sure you want commit this ? ');window.location='sales_page.php'; " ><i class="material-icons">done_all</i> Commit </button>

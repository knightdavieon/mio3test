      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;">
          ...
          <div class="body">
            ...
            <button type="submit" name="btn_commit" class="btn btn-primary"  style="margin-bottom: 25px; height:30px;padding-top:0;"><i class="material-icons">check_circle</i> Commit </button>

        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                             <h2><i class="material-icons">store_mall_directory </i> Receiving of items</h2>
                                 ...
                                 table.dataTable thead th{
                                      ...
                                      <table class="table table-striped table-bordered" id="r_items">
                                            <thead>
                                             ...
                                             <tbody>
                                                 <?php 
                                                    $query = "Select * from tbl_branch_transfer_series where transfer_to = '" . $_SESSION['b_code'] . "'";
                                                    ...
                                                    while($rows = mysqli_fetch_array($result)){
                                                     ...
                                                     ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo ($rows['transfer_status'] == "DONE") ? '<a href="branch_receiving_data.php?trans_num='. $rows['transaction_number'] .'" class="btn btn-primary" style="height:30px;"> Receive </a>' : '<small><label style="color:#e65c00;"> PENDING </label></small>'; ?></td>
                                                         </tr>
                                                    <?php
                                                          }
                                                    }

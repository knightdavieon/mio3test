            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                 <i class="material-icons"> store </i>  Branch Inventory Report
                            </h2>
                            ...
                            <div class="col-md-10 col-lg-10 col-xs-10 col-sm-10">
                              <?php 
                               ...
                               <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2" >
                                          <button type="submit" name="btn_search" class="btn btn-primary" style="height:30px;width:30px;padding:0px;margin-left:-15px;margin-top:28px;"><i class="material-icons">search </i>  </button>
                                        </div>
                        <?php
                           if(isset($_POST['s_branch'])){
                         ?>
                        <div class="col-md-10 col-lg-10 col-xs-10 col-sm-10">
                            <label><i class="material-icons"> info_outline </i> Information </label><br/>
                            <div class="col-md-5 col-lg-5">
                               <label> Branch Code : </label>
                             </div>
                              <div class="col-md-5 col-lg-5">
                                  <label><?php echo $_POST['s_branch'] ?></label>
                             </div>
                              ...
                              <div class="col-md-5 col-lg-5" style="margin-top:-15px;">
                                 <?php
                                      $branchf_result = mysqli_query($conn, "Select * from tbl_branches where branch_code = '" . mysqli_real_escape_string($conn, $_POST['s_branch']) . "'");
                                      $branchf_rows = mysqli_fetch_array($branchf_result)or die("Error : " . mysqli_error($conn));
                                  ?>
                               <label><?php echo $branchf_rows['branch_name']; ?></label>
                             </div>
                        </div>
                        <?php } ?>
                       ...
                       -->
                            ...
                            <script type="text/javascript">
                                ...
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"> </div>
                                   ...
                                   <div class="container-fluid" >
                                    <div class="col-md-10 col-lg-10 col-xs-10 col-sm-10">
                                     <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#selected_items" id="selected_button" style="height:30px;padding-top:0;margin-top:-40px;"><i class="material-icons"> remove_red_eye </i> View Selected Items </button> 
                                     <table class="table table-bordered table-striped" id="r_items">
                                                ...
                                                <tbody>
                                                     <?php 
                                                        if(isset($_POST['btn_search'])){
                                                             $search_query = "Select  * from tbl_branch_goods_receive where branch_name = '" . mysqli_real_escape_string($conn, $_POST['s_branch']) . "'";
                                                             $search_result = mysqli_query($conn, $search_query)or die('<script type="text/javascript"> alert("'. mysqli_error($conn) .'") </script>');
                                                             while($search_rows = mysqli_fetch_array($search_result)){
                                                                ?>
                                                                <tr>
                                                                   <td> <input type="checkbox" class="checkbox" id="<?php echo $search_rows['item_barcode']; ?>"><label for="<?php echo $search_rows['item_barcode']; ?>"></label> </td>
                                                                   <td><?php echo $search_rows['item_barcode']; ?></td>
                                                                   <td><?php echo $search_rows['item_name']; ?></td>
                                                                   <td><?php echo $search_rows['cat']; ?></td>
                                                                   <td><?php echo $search_rows['sub_category']; ?></td>
                                                                   <td><?php echo $search_rows['item_quantity']; ?></td>
                                                                   <td><?php echo $search_rows['item_price']; ?></td>
                                        ...
                                        <?php 
                                           if(isset($_POST['s_branch'])){
                                           ?>
                                              <input type="hidden" value="<?php echo $_POST['s_branch']; ?>" id="s_branch_value" name="s_branch_value">
                                          <?php        
                                           }
                                        ?>
                                      </div>
                                    ...
                                    <script type="text/javascript">
                                            $(document).ready(function(){
                                                  ...
                                                  $('#selected_button').click(function(){
                                                          ...
                                                          var s_branch_value = $('#s_branch_value').val();
                                                          if($('input:checkbox:checked').length > 0){
                                                               $('input:checkbox:checked').each(function(){
                                                                     ...
                                                                     $.ajax({
                                                                          type         :        "POST",
                                                                          url          :        "branch_inventory_reports_query.php",
                                                                          data         :        {'data':arrayList, s_branch_value:s_branch_value},
  ...
  <div class="modal-dialog" role="document" style="width:73%;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modifyModalLabel"><i class="material-icons">store</i> Branch Inventory Report </h5>

                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                         ...
                         <div class="body">
                           ...
                           <div class="col-md-12 col-sm-10 col-xs-10">
                                   <?php 
                                      ...
                                      // End
                                      // Item Sold
                                      $item_sold = "Select * from tbl_sales where transaction_number = '" . stripslashes($_GET['icode']) . "'";
                                      ...
                                      //END
                                      // Total Query
                                      $total_query = "Select Sum(total)as total_sales from tbl_sales where transaction_number = '" . stripslashes($_GET['icode']) . "'";
                                      ...
                                      // END
                                       // Staff query
                                      $staff_series = "Select * from tbl_sales_series where transaction_number = '" . stripslashes($_GET['icode']) . "'";
                                      $staff_series_result = mysqli_query($conn, $staff_series)or die('<script type="text/javascript"> alert("'.mysqli_error($conn).'") </script>');
                                      $staff_series_rows = mysqli_fetch_array($staff_series_result);
                                      // End
                                   ...
                                   ?>
                                    <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                      ...
                                      <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                        <label> <?php echo $item_rows['transaction_number']; ?>  </label>
                                      </div>
                                     <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                      ...
                                      <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                        <label> <?php echo (isset($staff_rows['customer_name'])) ? $staff_rows['customer_name'] : '--' ?></label>
                                      </div>
                                       <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                        <label> Cash : </label>
                                      </div>
                                      <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                        <label style="color:#ff0000;"><small> <?php echo "P". $staff_series_rows['customer_cash']; ?></small></label>
                                      </div>
                                        <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                        <label> Changed : </label>
                                      </div>
                                      <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                                        <label style="color:#ff0000;"><small> <?php echo "P". $staff_series_rows['customer_change']; ?></small></label>
                                      </div>
                                       <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5">
                  ...
                  <!--#END# First Form -->
                    ...
                    <div class="card">
                                       ...
                                       <table id="r_items" class="table table-striped table-bordered">
                                               <thead>
                                                 ...
                                                 <tbody>
                                                      <?php 
                                                        if(isset($_GET['icode'])){
                                                         $info_query = "Select * from tbl_sales where transaction_number = '" . stripslashes($_GET['icode']) . "'";
                                                         $info_result = mysqli_query($conn, $info_query);
                                                         while($info_rows = mysqli_fetch_array($info_result)){
                                                             ?>
                                                            <tr>
                                                                <td><?php echo $info_rows['item_barcode']; ?></td>
                                                                <td><?php echo $info_rows['item_name']; ?></td>
                                                                <td><?php echo $info_rows['quant']; ?></td>
                                                                <td><?php echo $info_rows['price']; ?></td>
                                                                <td><?php echo $info_rows['total']; ?> </td>
                                                                <td><?php echo $info_rows['date_transaction']; ?> </td>
                                                              </tr>
                                                            <?php
                                                         }
                                                        }
                       ...
                       <a href="sales_profile.php" class="btn btn-warning" style="height:30px;padding-top:0;"><i class="material-icons"> arrow_back</i> Back  </a>

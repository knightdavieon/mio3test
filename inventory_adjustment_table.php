                                                        ...
                                                        while($item_rows = mysqli_fetch_array($item_result)){
                                                            ?>
                                                             <tr>
                                                                ...
                                                                <td><?php echo $item_rows['date_received']; ?></td>
                                                                <td>
                                                                 <a href="inventory_adjustment_page.php?icode=<?php echo $item_rows['item_barcode']; ?>" class="btn btn-primary" style="width:30px;height:30px;" title="Edit"><i class="material-icons" style="margin-left:-6px;margin-top:-5px;">mode_edit</i> </a>
                                                                 <!--

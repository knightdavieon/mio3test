            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">move_to_inbox </i> Transfer of Items History
                                 ...
                                 table.dataTable thead th{
                                      ...
                                      <table id="r_items" class="table table-bordered table-striped">
                                            <thead>
                                              ...
                                              <tbody>
                                                    <?php 
                                                       $branch_query = "Select * from tbl_branch_transfer_series where branch_code = '" . $_SESSION['b_code'] . "'";
                                                       ...
                                                       while($branch_rows = mysqli_fetch_array($branch_result)){
                                                        ?>
                                                           <tr>
                                                              <td><a href="branch_transfer_history_data.php?icode=<?php echo $branch_rows['transaction_number']; ?>"><?php echo $branch_rows['transaction_number']; ?></a></td>
                                                              <td><?php echo $branch_rows['staff_code']; ?></td>
                                                              <td><?php echo $branch_rows['staff_name']; ?></td>
                                                              <td><label><?php echo $branch_rows['transfer_to']; ?></label></td>
                                                              <td><?php echo $branch_rows['transaction_date']; ?></td>
                                                            </tr>
                                                        <?php 
                                                       }
                                                    ?>

        ...
        <div class="container-fluid">
            ...
            <!-- Input -->
               <!-- Item Information Form -->
                <a href="sales_reports.php" style="height:30px;width:70px;padding-top:0px;" class="btn btn-warning"><i class="material-icons" style="margin-left:-2px;"> arrow_back </i> Back </a>
                        ...
                        <div class="header">
                         ...
                         <div class="body">
                           ...
                           <div class="col-md-12 col-sm-10 col-xs-10">
                                   <?php 
                                       $info_query = "Select * from tbl_sales_series where transaction_number = '" . stripslashes($_GET['scode']) . "' and branch = '" . mysqli_real_escape_string($conn, $_GET['bcode']) . "'";
                                       $info_result = mysqli_query($conn, $info_query);
                                       $info_rows = mysqli_fetch_array($info_result);
                                       $items_query = "Select * from tbl_sales where transaction_number = '" . stripslashes($_GET['scode']) . "' and branch = '" . mysqli_real_escape_string($conn, $_GET['bcode']) . "'";
                                       $items_result = mysqli_query($conn, $items_query);
                                       $items_count = mysqli_num_rows($items_result);
                                       $total_query = "Select Sum(total)as t_data from tbl_sales where transaction_number = '" . stripslashes($_GET['scode']) . "' and branch = '" . mysqli_real_escape_string($conn, $_GET['bcode']) . "'";
                                    ...
                                    <div class="col-md-4 col-lg-5 col-sm-5 col-xs-5">
                                      ...
                                      <div class="col-md-4 col-lg-5 col-sm-5 col-xs-5">
                                         ...
                                         <div class="col-md-4 col-lg-5 col-sm-5 col-xs-5">
                                          ...
                                          <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5">
                                            <label>  <?php echo (!empty($info_rows['customer_name']) ? $info_rows['customer_name'] : '---'); ?>  </label>
                                         </div>
                                           <?php 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                         ...
                         <div class="body">
                            ...
                            <div class="row clearfix">
                           <div class="col-md-12 col-sm-10 col-xs-10">
                                    <a href="swho_sales_print.php?scode=<?php echo stripslashes($_GET['scode']); ?>" target="_blank" class="btn btn-warning" style="height:30px;padding-top:0px;"><i class="material-icons"> print </i> Print Preview </a>
                                    <a href="swho_sales_pdf.php?scode=<?php echo stripslashes($_GET['scode']) ?>" class="btn btn-danger" style="height:30px;padding-top:0px;" target="_blank"><i class="material-icons">picture_as_pdf </i> Export as PDF </a>
                               </div> <!-- End of Row Division -->     
                             </div>
                                 ...
                                 <style type="text/css">
                                     ...
                                     <table class="table table-bordered table-striped" id="r_items">
                                             <thead>
                                                ...
                                                <tbody>
                                                     <?php 
                                                        $data_query = "Select * from tbl_sales where transaction_number = '" . stripslashes($_GET['scode']) . "' and branch = '" . mysqli_real_escape_string($conn, $_GET['bcode']) . "'";
                                                        ...
                                                        while($data_rows = mysqli_fetch_array($data_result)){
                                                         ...
                                                         <tr>
                                                               ...
                                                               <td><?php echo $data_rows['total']; ?></td>

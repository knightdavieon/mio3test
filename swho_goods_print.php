...
<h3> <strong> GOODS RECEIVE </strong> </h3>
<table border="2" style="width:100%;" >
 <tr>
       <td style="width:250px;"> Docket Number :  <?php echo $rows['docket_number']; ?></td>
       <td rowspan="10"> Received By : <?php echo $rows['person_received']; ?> </td>
    </tr>
    <tr>
...
<table border="2" style="width:100%;margin-top:1px;">
      <thead>
         ...
         <tbody>
              <?php 
                 $trans_query = "Select * from tbl_goods_receive_history where docket_number = '" . stripslashes($_GET['dcode']) . "'";

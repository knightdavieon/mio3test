                    ...
                    <div class="card">
                        <div class="header">
                         ...
                         <div class="body">
                            ...
                            <div class="row clearfix">
                            <button type="button" class="btn btn-primary" id="view_selected" data-toggle="modal" data-target="#selected_items" style="height:30px;padding-top:0;margin-left:10px;"><i class="material-icons">remove_red_eye </i> View Selected Items </button>
                                 ...
                                 <style type="text/css">
                                     ...
                                     <table class="table table-bordered table-striped" id="r_items">
                                             <thead>
                                                ...
                                                <tbody>
                                                     <?php 
                                                        $data_query = "Select * from tbl_transaction_series";
                                                        $data_result = mysqli_query($conn, $data_query);
                                                        while($data_rows = mysqli_fetch_array($data_result)){
                                                             ?>
                                                         <tr>
                                                           <td> <input type="checkbox" class="checkbox" id="<?php echo $data_rows['transfer_number']; ?>" name="id[]"><label for="<?php echo $data_rows['transfer_number']; ?>"></label></td>
                                                           <td><?php echo $data_rows['transfer_number']; ?></td>
                                                           <td><?php echo $data_rows['branch_name']; ?></td>
                                                           <td><small><?php echo $data_rows['date_received']; ?></small></td>
                                                           <td><a href="swho_transfer_items_data.php?ts_number=<?php echo $data_rows['transfer_number']; ?>" class="btn btn-primary" style="height:30px;width:30px;padding-top:0;"><i class="material-icons" style="margin-left:-7px;margin-top:2px;"> remove_red_eye</i> </a></td> 
                                                         </tr>  
                                                            <?php
                                                        }
                                                     ?>
                                                      ...
                                                      $('#view_selected').click(function(){
                                                                ...
                                                                if($('input:checkbox:checked').length > 0){
                                                                      $('input:checkbox:checked').each(function(){
                                                                             ...
                                                                             $.ajax({
                                                                                   type      :        "POST",
                                                                                   url       :        "swho_transfer_selected_query.php",
                                                                                   data      :        {'data':arrayList},
  ...
  <div class="modal-dialog" role="document" style="width:83%;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modifyModalLabel"><i class="material-icons"> transfer_within_a_station </i>  Transfer Stocks Reports</h5>

...
<head>
    ...
    <title> Branch Transfer Stocks </title>
    <!-- Favicon-->
                                              ...
                                              <tbody>
                                                    <?php 
                                                       ...
                                                       while($branch_rows = mysqli_fetch_array($branch_result)){
                                                        ?>
                                                           <tr>
                                                              <td><a href="swho_branch_transfer_stocks_data.php?icode=<?php echo $branch_rows['transaction_number']; ?>"><?php echo $branch_rows['transaction_number']; ?></a></td>
                                                              <td><?php echo $branch_rows['staff_code']; ?></td>
                                                              <td><?php echo $branch_rows['staff_name']; ?></td>
                                                              <td><strong><?php echo $branch_rows['transfer_to']; ?></strong></td>

...
$fullDate = $month . "/" . $day . "/" . $year;
                             if(isset($_POST['btn_csv_export'])){
                                    ...
                                    header('Content-Disposition: attachment; filename='. $_SESSION['b_code'] .'_Sales_Record.csv'); 
                                    ...
                                    $sales_inf_query = mysqli_query($conn, "Select * from tbl_sales where branch = '" . $_SESSION['b_code'] . "'");
                                    $sales_array = array();
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form method="post" name="test" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                           ...
                           <div class="col-md-5 col-lg-5 col-sm-10 col-xs-10">      
                            ...
                            <div class="col-md-1 col-lg-1 col-sm-10 col-xs-10">
                            <button type="submit" name="btn_search" class="btn btn-primary" style="height:30px;width:30px;padding-top:5px;padding:0;margin-top:26px;"><i class="material-icons"> search </i> </button>
                            </div>
                       </div>
                      ...
                      <?php 
                           if(isset($_POST['btn_search'])){    
                                if(!empty($_POST['from_date_value']) && !empty($_POST['to_date_value'])){
                                    ...
                                    $date_range_query .= " and branch = '" . $_SESSION['b_code'] . "'";
                                    ...
                                    $ts_query = "Select Sum(total) as branch_total from tbl_sales where branch = '" . $_SESSION['b_code'] . "'";
                                    $ts_result = mysqli_query($conn, $ts_query);
                                    $ts_rows = mysqli_fetch_array($ts_result);
                                    ?>
                                    <label style="color:#e60000;"> <small><?php echo "P" . $ts_rows['branch_total']; ?> </small> </label>
                                    <?php
                                }
                              ?>
                                </div>
                                   ...
                                   <?php 
                                    if(isset($_POST['btn_search'])){
                                      if(!empty($_POST['from_date_value']) && !empty($_POST['to_date_value'])){
                                          ...
                                          $ts_query = "Select * from tbl_sales where branch = '" . $_SESSION['b_code'] . "'";
                                          $ts_result = mysqli_query($conn, $ts_query);
                                          $ts_count = mysqli_num_rows($ts_result);
                                          ?>
                                            <label> <?php echo $ts_count; ?> </label>
                                        <?php
                                      }
                                   ?>
                                                ...
                                                <tbody>
                                                     <?php 
                                                             ...
                                                             if(!empty($_POST['from_date_value']) && !empty($_POST['to_date_value'])){
                                                                   ...
                                                                   $date_range_query .= " and branch = '" . $_SESSION['b_code'] . "'";
                                                                   $date_range_result = mysqli_query($conn, $date_range_query);
                                                                   while($date_range_rows = mysqli_fetch_array($date_range_result)){
                                                                    ...
                                                                    <tr>
                                                                      <td> <input type="checkbox" class="checkbox" id="<?php echo $date_range_rows['transaction_number']; ?>" name="id[]"><label for="<?php echo $date_range_rows['transaction_number']; ?>"> </label> </td>
                                                                       ...
                                                                       <td><a href="branch_sales_report_data.php?scode=<?php echo $date_range_rows['transaction_number']; ?>&amp;bcode=<?php echo $sales_rows['branch']; ?>" class="btn btn-info" style="height:30px;width:30px;padding-top:0;"><i class="material-icons" style="margin-left:-7px;margin-top:2px;"> remove_red_eye </a> </a></td>
                                                                      </tr>
                                                                        <?php
                                                                   }
                                                             }else{
                                                                ...
                                                                $sales_query = "Select * from tbl_sales_series where branch = '" .  $_SESSION['b_code'] . "'";
                                                                ...
                                                                while($sales_rows = mysqli_fetch_array($sales_result)){
                                                                    ...
                                                                    <tr>
                                                                      <td> <input type="checkbox" class="checkbox" id="<?php echo $sales_rows['transaction_number']; ?>" name="id[]"><label for="<?php echo $sales_rows['transaction_number']; ?>"> </label> </td>
                                                                       ...
                                                                       <td><a href="branch_sales_report_data.php?scode=<?php echo $sales_rows['transaction_number'] ;?>&amp;bcode=<?php echo $sales_rows['branch']; ?>" class="btn btn-info" style="height:30px;width:30px;padding-top:0;"><i class="material-icons" style="margin-left:-7px;margin-top:2px;"> remove_red_eye </a> </a></td>
                                                                      </tr>
                                                                    <?php
                                                                }
                                                           }
                                                       ...
                                                       $('#btn_view').click(function(){
                                                             ...
                                                             if($('input:checkbox:checked').length > 0){
                                                                  $('input:checkbox:checked').each(function(){
                                                                       ...
                                                                       $.ajax({
                                                                           type     :     "POST",
                                                                           url      :     "branch_sales_report_tabledata.php",
                                                                           data     :     {'data':arrayList},

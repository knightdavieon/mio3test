...
<head>
    ...
    <title> Goods Receives Reports </title>
    <!-- Favicon-->
                                             ...
                                             <thead>
                                                  ...
                                                  <tbody>
                                                       <?php 
                                                        ...
                                                        $ts_query = "Select * from tbl_goods_receive_history_series";
                                                        $ts_result = mysqli_query($conn, $ts_query)or die("Error : " . mysqli_error($conn));
                                                        while($ts_rows = mysqli_fetch_array($ts_result)){
                                                          ?>
                                                           <tr>
                                                       
                                                                <td><a href="goods_receive_reports_page.php?dcode=<?php echo $ts_rows['docket_number']; ?>"><?php echo $ts_rows['docket_number']; ?></a></td>
                                                                <td><?php echo $ts_rows['employee_code']; ?></td>
                                                                <td><?php echo $ts_rows['name_of_receiver']; ?></td>

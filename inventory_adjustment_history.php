...
<head>
    ...
    <title> Inventory Adjustment History </title>
    <!-- Favicon-->
...
<body class="theme-black">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- Input -->
             <a href="inventory_adjustment_page.php?icode=<?php echo stripslashes($_GET['icode']); ?>" class="btn btn-warning" style="height:30px;padding-top:0px;margin-top:-10px;"><i class="material-icons" style="margin-top:2px;"> arrow_back </i> Back </a>
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                   <i class="material-icons"> adjust </i> Inventory Adjustment History
                                ...
                                table.dataTable thead th{
                                    ...
                                    <table id="r_items" class="table table-striped table-bordered">
                                          <thead>
                                             ...
                                             <tbody>
                                                   <?php 
                                                      $history_query = "Select * from tbl_goods_edit_history order by edit_date";
                                                      $history_result = mysqli_query($conn, $history_query);
                                                      while($history_rows = mysqli_fetch_array($history_result)){
                                                      ?>
                                                      <tr>
                                                          <td><?php echo $history_rows['item_barcode']; ?></td>
                                                          <td><?php echo $history_rows['description']; ?></td>
                                                          <td><?php echo $history_rows['cat']; ?></td>
                                                          <td><?php echo $history_rows['sub_cat']; ?></td>
                                                          <td><?php echo $history_rows['eic']; ?></td>
                                                          <td><?php echo $history_rows['edit_date']; ?></td>
                                                        </tr>
                                                     <?php
                                                      }
                                                   ?>
